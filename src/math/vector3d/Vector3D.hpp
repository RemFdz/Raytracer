...
namespace Math {
    ...
    public:
        ...
        static inline Vector3D random() { return {Utils::Randomizer::getRandomDouble(),
                                                  Utils::Randomizer::getRandomDouble(),
                                                  Utils::Randomizer::getRandomDouble()}; }

        static Vector3D random(double min, double max) {
            return { Utils::Randomizer::getRandomDouble(min,max), Utils::Randomizer::getRandomDouble(min,max),
                     Utils::Randomizer::getRandomDouble(min,max) };
        }
